...
if __name__ == '__main__':
    ...
    ap.add_argument("-i", "--input",help="path to original input image")
    ap.add_argument("-o", "--output",help="path to output adversarial image")
    ap.add_argument("-c", "--class-idx", type=int ,default=10, help="ImageNet class ID of the predicted label")
